DROP policy "Users can interact by sending messages" ON "public"."Messages";
...
ALTER TABLE
  "public"."Messages"
ADD
  column "has_image" BOOLEAN NOT NULL DEFAULT FALSE;
...
CREATE policy "Users can interact by sending messages" ON "public"."Messages" AS permissive FOR
INSERT
